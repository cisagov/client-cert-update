...
```console
docker run cisagov/client-cert-update:0.1.0-rc.3
```
...
1. Create a `docker-compose.yml` file similar to the one below to use [Docker Compose](https://docs.docker.com/compose/).
    ...
    services:
      update:
        image: cisagov/client-cert-update:0.1.0-rc.3
        init: true
        environment:
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/client-cert-update:0.1.0-rc.3
    ```
...
|-----------|-------------|
|`cisagov/client-cert-update:0.1.0-rc.3`| An exact release version. |
...
```console
docker build \
  --tag cisagov/client-cert-update:0.1.0-rc.3 \
